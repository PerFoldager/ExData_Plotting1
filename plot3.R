...
## The file household_power_consumption.txt is input and the result of the processing is a histogram saved as PNG file plot3.png
...
plot3 <- function() {
  ...
  legend("topright", 
         ...
         bty = "o", box.col="black", lwd=2, cex=1.0,y.intersp=1.1, col=c("black","red","blue"), lty=c(1,1,1))  
